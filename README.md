...
| Model 7    | Brightfield     | IoU = 0.882 <br> f1 = 0.968 | StarDist model to detect cancer cells in BSA-coated channels. Used to measure perfusion speed inside the channels (10x magnification) | [Link](https://zenodo.org/uploads/13304399) | [StarDist 2D Notebook](https://github.com/HenriquesLab/ZeroCostDL4Mic/wiki#segmentation-networks) |
| ...        | ...            | ...  | ...         | ...                             | ...                   | ...                    |
